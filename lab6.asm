...
mov cx, es:sekundnik ; licznik do 19
add cx, 1
cmp cx, 19
jb pomin_wypisywanie
mov cx, 0
...
; asemblacja (MASM 4.0): masm gwiazdki.asm,,,;
; konsolidacja (LINK 3.60): link gwiazdki.obj;
; 80 znaków na wiersz czyli 160 bajtów
; 25 wierszy
.386
rozkazy SEGMENT use16
ASSUME CS:rozkazy
...
jb wysw_dalej ; skok gdy nie koniec ekranu
; wyzerowanie adresu bieżącego, gdy cały ekran zapisany
add cs:kolumna, 2 ; zwiększam kolumnę o 2 bajty
mov bx, cs:kolumna ; ustawiam licznik na aktualna kolumne
add bx, 320 ; zaczynam od 2 wiersza
;zapisanie adresu bieżącego do zmiennej 'licznik'
wysw_dalej:
mov cs:licznik,bx
...
; w zmiennej 'wektor8' (wektor nr 9 zajmuje w pamięci 4 bajty

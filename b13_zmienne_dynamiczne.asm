...
mov ebp, esp
sub esp,4
mov [ebp-4], dword PTR ' ' ; zmienna dynamiczna przechowująca znak, domyślnie ' '
bt eax, 31
jnc pomin_negacje
neg eax
mov [ebp-4],dword PTR '-'
...
xor edx,edx
 mov   dl, [ebp-4] ; kod spacji 
 mov   byte PTR znaki [esi], dl
 dec esi
wypeln: 
 or  esi, esi 
...
mov ebp, esp
sub esp,4
mov [ebp-4], dword PTR ' ' ; ustawienie zmiennej dynamicznej
mov ebx, 13
